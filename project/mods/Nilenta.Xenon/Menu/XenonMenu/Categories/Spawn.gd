...
func setup(Player: Node, PlayerData: Node, Globals: Node, Interface: VBoxContainer, Data, _tree, Network, _posData, PopupMsg) -> void:
	...
	xenon_panels_data = [
		{
			"name": "Object",
			"description": "Object/Prop you want to spawn.",
			"elements": [
		...
		{
			"name": "Amount",
			"description": "Amount of object/prop you want to spawn.",
			"elements": [
		...
		{
			"name": "Offset (X, Y, Z)",
			"description": "Offset from the player.",
			"elements": [
		...
		{
			"name": "Steam ID",
			"description": "Spawns under the SteamID, if you dont know what this does just leave it at 0.",
			"elements": [
